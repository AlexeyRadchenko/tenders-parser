...
class Customer(object):
    def __init__(self, max_price=None, guarantee_app=None, guarantee_contract=None, customer_guid=None, customer_name=None, currency=None):
        self.entities = []
    ...
    def add_guarantee_app(self, guarantee_app):
        self.entities.append(Field(
            value=guarantee_app,
            name="guaranteeApp",
            displayName="Размер обеспечения заявки участника/задатка оператору",
            type=FieldType.Price,
            modifications=[]
        ))
        return self
