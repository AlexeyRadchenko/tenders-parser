    ...
    def test_get_tender_data_rd(self):
        ...
        true_result = {
            ...
            'positions': [
                ...
                {'num': '2', 
                'notice': 'Трубы по ГОСТ 550-75 из стали 15Х5М \nдолжны соответствовать требованиям: 1.Партия должна состоять из труб \nодной плавки и иметь единый документ о качестве с указанием химического \nсостава и сведений о термообработке.  2. Группа «А». 3.Термообработка. \n4. Гидроиспытание. 5. Контроль неразрушающими методами (рентген или УЗД)\n по всей поверхности. 6. Испытание на загиб и раздачу. 7.Испытание на \nсплющивание для труб.', 'quantity': '3081', 'name': 'Труба 25х2,5х13000 ст.15Х5М ГОСТ 550-75', 'measure': 'м'}, {'num': '3', 'notice': 'Трубы по ГОСТ 550-75 из стали 15Х5М \nдолжны соответствовать требованиям: 1.Партия должна состоять из труб \nодной плавки и иметь единый документ о качестве с указанием химического \nсостава и сведений о термообработке.  2. Группа «А». 3.Термообработка. \n4. Гидроиспытание. 5. Контроль неразрушающими методами (рентген или УЗД)\n по всей поверхности. 6. Испытание на загиб и раздачу. 7.Испытание на \nсплющивание для труб.', 'quantity': '2713,5', 'name': 'Труба 25х2,5х13500 ст.15Х5М ГОСТ 550-75', 'measure': 'м'}, {'num': '4', 'notice': 'Трубы по ГОСТ 550-75 из стали 15Х5М \nдолжны соответствовать требованиям: 1.Партия должна состоять из труб \nодной плавки и иметь единый документ о качестве с указанием химического \nсостава и сведений о термообработке.  2. Группа «А». 3.Термообработка. \n4. Гидроиспытание. 5. Контроль неразрушающими методами (рентген или УЗД)\n по всей поверхности. 6. Испытание на загиб и раздачу. 7.Испытание на \nсплющивание для труб.', 'quantity': '126', 'name': 'Труба 25х2,5х14000 ст.15Х5М ГОСТ 550-75', 'measure': 'м'}], 'status': 'Опубликован', 'fio': 'Шевченко Т. Ю.', 'sub_order': ' - информация по заказу доступна всем пользователям  - к участию допускаются только приглашенные организации  - к участию автоматически допускаются все участники, подавшие заявки на участие  - специальные предложения (аналоги, замены) НЕ допускаются  - необходимо указать цены по всем позициям заказа', 'number': 'РД-180925-7', 'customer': 'БМЗ', 'delivery_terms': 'Поставка\n не более 45 календарных дней. Доставка за счёт продавца. В случае \nнеобходимости Поставщик обязуется осуществлять самодекларирование по \nисполнению договорных обязательств (Поставщик формирует основные вехи \nисполнения заказа, график контрольных сроков и предоставляет информацию \nпо его исполнению). ', 'price': 3232346.0, 'scoring_date': ('02.10.2018 10:30', None), 'sub_start_date': None, 'attachments': [{'real_name': 'Приглашение.pdf', 'publication_date': ('01.10.2018 08:54', None), 'size': '471,78 KB', 'url': 'https://etp.tatneft.ru/pls/tzp/wwv_flow.show?p_flow_id=220&p_flow_step_id=2155&p_request=APPLICATION_PROCESS=APX_CARD_FILE_DOWNLOAD&x01=2093909700021&x02=87539780000&x03=87507700000', 'display_name': 'Приглашение'}, {'real_name': 'Спецификация.xls', 'publication_date': ('01.10.2018 08:54', None), 'size': '54,5 KB', 'url': 'https://etp.tatneft.ru/pls/tzp/wwv_flow.show?p_flow_id=220&p_flow_step_id=2155&p_request=APPLICATION_PROCESS=APX_CARD_FILE_DOWNLOAD&x01=2093910220021&x02=87539780000&x03=87507700000', 'display_name': 'Спецификация'}, {'real_name': 'Условия поставки.pdf', 'publication_date': ('01.10.2018 08:54', None), 'size': '148,01 KB', 'url': 'https://etp.tatneft.ru/pls/tzp/wwv_flow.show?p_flow_id=220&p_flow_step_id=2155&p_request=APPLICATION_PROCESS=APX_CARD_FILE_DOWNLOAD&x01=2093909440021&x02=87539780000&x03=87507700000', 'display_name': 'Условия поставки'}, {'real_name': 'Анкета ТН.docx', 'publication_date': ('01.10.2018 08:54', None), 'size': '19,56 KB', 'url': 'https://etp.tatneft.ru/pls/tzp/wwv_flow.show?p_flow_id=220&p_flow_step_id=2155&p_request=APPLICATION_PROCESS=APX_CARD_FILE_DOWNLOAD&x01=2093910260021&x02=87539780000&x03=87507700000', 'display_name': 'Анкета ТН.'}, {'real_name': 'Гарантийное письмо ТН.doc', 'publication_date': ('01.10.2018 08:54', None), 'size': '36 KB', 'url': 'https://etp.tatneft.ru/pls/tzp/wwv_flow.show?p_flow_id=220&p_flow_step_id=2155&p_request=APPLICATION_PROCESS=APX_CARD_FILE_DOWNLOAD&x01=2093910340021&x02=87539780000&x03=87507700000', 'display_name': 'Гарантийное письмо ТН'}, {'real_name': 'Макет договора.doc', 'publication_date': ('01.10.2018 08:54', None), 'size': '675 KB', 'url': 'https://etp.tatneft.ru/pls/tzp/wwv_flow.show?p_flow_id=220&p_flow_step_id=2155&p_request=APPLICATION_PROCESS=APX_CARD_FILE_DOWNLOAD&x01=2093909480021&x02=87539780000&x03=87507700000', 'display_name': 'Макет договора'}], 'id': 'РД-180925-7_1', 'sub_close_date': None, 'type': 'Редукцион', 'publication_date': ('01.10.2018 08:54', None), 'name': 'Поставка труб (согл-836383615-1) (2486/ИсхОрг(335))'}
