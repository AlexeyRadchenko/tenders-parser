...
class Unittest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.path_after_active_tender_list = 'test/files/after_active_tender_list.html'
        self.path_after_active_tender_data = 'test/files/after_active_tender_data.html'
        self.path_after_arc_tender_list = 'test/files/after_arc_tender_list.html'
        self.path_before_active_tender_list = 'test/files/before_active_tender_list.html'
        self.path_before_arc_tender_list = 'test/files/before_arc_tender_list.html'
